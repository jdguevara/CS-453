...
/**
 * Prints out all the lists of available blocks in the Buddy system. This is
 *    incredibly useful for testing and debugging purposes.  The provided
 *    buddy-unit-test.c requires this functionality.
 */
void print_buddy_lists(void);

/**
 * Return the kval that cooresponds to the smallest block
 *    that can be stored in the buddy list. This is
 *    incredibly useful for testing and debugging purposes.  The provided
 *    buddy-unit-test.c requires this functionality.
 */
int get_min_k(void);
...
/**
 * Return the kval that cooresponds to the largest block
 *    that can be stored in the buddy list.  This is
 *    incredibly useful for testing and debugging purposes.  The provided
 *    buddy-unit-test.c requires this functionality.
 */
...
/* These methods will be implemented in part 2 of the Buddy Memory Manager project */
#ifdef BUDDY_PRELOAD
